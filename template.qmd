...
Use the table and tabular commands for basic tables --- see @tab-widgets, for example. [TablesGenerator.com](http://tablesgenerator.com) is a handy tool for designing tables and generating the LaTeX code, which you can copy and paste into your article here.
